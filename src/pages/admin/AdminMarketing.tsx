...
const AdminMarketing: React.FC = () => {
  ...
  const estadisticas = {
    ...
    clientesAlcanzados: 342,
    tasaConversion: 12.5,
    ventasGeneradas: 45680
  };

  const promociones = [
    { id: 1, nombre: '2x1 en Blusas', descuento: '50%', inicio: '2025-02-20', fin: '2025-03-20', activo: true, usos: 45 },
    { id: 2, nombre: 'Descuento Primavera', descuento: '20%', inicio: '2025-02-15', fin: '2025-03-31', activo: true, usos: 89 },
    { id: 3, nombre: 'Compra Mayor', descuento: '15%', inicio: '2025-02-01', fin: '2025-02-28', activo: false, usos: 156 },
  ];

  const campanas = [
    { id: 1, nombre: 'Newsletter Febrero', tipo: 'Email', enviados: 450, abiertos: 234, clicks: 89, fecha: '2025-02-15' },
    { id: 2, nombre: 'Promoción San Valentín', tipo: 'WhatsApp', enviados: 280, abiertos: 245, clicks: 102, fecha: '2025-02-10' },
  ];
            ...
            <Card sx={{ background: 'linear-gradient(135deg, #E91E8C 0%, #C2185B 100%)', color: 'white' }}>
              <CardContent>
                <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  <Box>
                    <Typography variant="body2" sx={{ opacity: 0.9 }}>Promociones Activas</Typography>
          ...
          <Grid size={{ xs: 12, sm: 6, md: 3 }}>
            <Card sx={{ background: 'linear-gradient(135deg, #F06292 0%, #E91E8C 100%)', color: 'white' }}>
              <CardContent>
                <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  <Box>
                    <Typography variant="body2" sx={{ opacity: 0.9 }}>Clientes Alcanzados</Typography>
                    <Typography variant="h4" sx={{ fontWeight: 'bold', mt: 1 }}>
          ...
          <Grid size={{ xs: 12, sm: 6, md: 3 }}>
            <Card sx={{ background: 'linear-gradient(135deg, #F8BBD0 0%, #F06292 100%)', color: 'white' }}>
              <CardContent>
                <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  <Box>
                    <Typography variant="body2" sx={{ opacity: 0.9 }}>Tasa de Conversión</Typography>
                    <Typography variant="h4" sx={{ fontWeight: 'bold', mt: 1 }}>
          ...
          <Grid size={{ xs: 12, sm: 6, md: 3 }}>
            <Card sx={{ background: 'linear-gradient(135deg, #FCE4EC 0%, #F8BBD0 100%)', color: '#E91E8C' }}>
              <CardContent>
                <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  <Box>
                    <Typography variant="body2" sx={{ opacity: 0.9 }}>Ventas Generadas</Typography>
          ...
          <Paper sx={{ boxShadow: '0 2px 8px rgba(0,0,0,0.08)' }}>
            <TableContainer>
              <Table>
                ...
                <TableBody>
                  {campanas.map((camp) => {
                    const tasaApertura = ((camp.abiertos / camp.enviados) * 100).toFixed(1);
                    const tasaClick = ((camp.clicks / camp.abiertos) * 100).toFixed(1);
                    return (
