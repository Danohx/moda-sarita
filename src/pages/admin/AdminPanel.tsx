    ...
    <AdminLayout role="admin">
      <Box>
            ...
            <Table>
              <TableHead>
                <TableRow sx={{ bgcolor: '#FDE8F4' }}>
                  ...
                  <TableCell><strong style={{ color: '#E91E8C' }}>Contacto</strong></TableCell>
                  <TableCell align="center"><strong style={{ color: '#E91E8C' }}>Límite Crédito</strong></TableCell>
                  <TableCell align="center"><strong style={{ color: '#E91E8C' }}>Saldo Actual</strong></TableCell>
              ...
              <TableBody>
                {customers.map((customer) => (
                  <TableRow key={customer.id} hover sx={{ '&:hover': { bgcolor: '#FFF5FA' } }}>
                    ...
                    <TableCell align="center">
                      <IconButton size="small" onClick={() => handleViewCustomer(customer)} sx={{ color: '#E91E8C' }}>
                        <Visibility />
                      </IconButton>
                      <IconButton size="small" onClick={() => handleViewCustomer(customer)} sx={{ color: '#E91E8C' }}>
                        <Edit />
                      ...
                      {customer.creditLimit > 0 && (
                        <IconButton size="small" onClick={() => handleEditCredit(customer)} sx={{ color: '#E91E8C' }}>
                          <CreditCard />
                        </IconButton>
                      )}
                    </TableCell>
                  ...
                  <CardContent>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
                      ...
                      <Chip
                        ...
                        size="small"
                        sx={{
                          bgcolor: selectedCustomer?.creditLimit && selectedCustomer.creditLimit > 0 ? '#E8F5E9' : '#FFEBEE',
                          color: selectedCustomer?.creditLimit && selectedCustomer.creditLimit > 0 ? '#2E7D32' : '#C62828',
                          fontWeight: 'bold'
                        }}
                      />
                    </Box>
                  ...
                  <CardContent>
                    ...
                    <Grid container spacing={2} sx={{ mt: 1 }}>
                      ...
                      <Grid size={{ xs: 4 }} sx={{ textAlign: 'center' }}>
                        ...
                        <Typography variant="caption" color="text.secondary">Apartados</Typography>
                      </Grid>
                      <Grid size={{ xs: 4 }} sx={{ textAlign: 'center' }}>
                        <Typography variant="h6" sx={{ color: '#E91E8C', fontWeight: 'bold' }}>
        ...
        >
          ...
          <DialogContent sx={{ mt: 2 }}>
            {/* Estado Actual */}
            <Card sx={{ background: 'linear-gradient(135deg, #E91E8C 0%, #C2185B 100%)', color: 'white', mb: 3 }}>
              <CardContent>
